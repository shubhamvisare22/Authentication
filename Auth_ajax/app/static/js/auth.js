$(document).ready(function () {
    ...
    $("#login_btn").click(function (e) {
        ...
        if (username == '') {
            ...
            let myData = { username: username, password: password, csrfmiddlewaretoken: csrf }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == 1) {
                        ...
                        // $("#username_id").val('')
                        $("#pass_id").val('')
                        toastr.error('Username or password is incorrect.', '', { timeOut: 1000 })
    ...
    $("#register_btn").click(function (e) {
        ...
        if (first_name == '') {
            ...
            let myData = { first_name: first_name, last_name: last_name, username: username, password: password, confirm_password: confirm_password, csrfmiddlewaretoken: csrf }
    ...
    //  show hide password : not working 

    $(".show-password, .hide-password").on('click', function () {
        // // body > div > div > div > div > form > div:nth-child(6)
        // var passwordId = $(this).parents('div').find('input').attr('id');
        console.log('passid:  ',passwordId)
